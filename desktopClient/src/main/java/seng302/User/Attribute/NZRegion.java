...
public enum NZRegion {
    ...
    TKI("Taranaki"),MWT("Manawatu-Wanganui"),WGN("Wellington"),TAS("Tasman"),NSN("Nelson"),MBH("Marlborough"),WTC("West Coast"),CAN("Canterbury"),OTA("Otago"),STL("Southland"),CHI("Chatham Islands");
