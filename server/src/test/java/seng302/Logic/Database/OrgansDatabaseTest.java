...
public class OrgansDatabaseTest {
    ...
    public void insertOrganTest() throws SQLException{
        DonatableOrgan donatableOrgan = new DonatableOrgan(LocalDateTime.now().plusHours(4), Organ.EAR, 3,false, 0);
    ...
    public void updateOrganTest() throws SQLException{
        DonatableOrgan donatableOrgan = new DonatableOrgan(LocalDateTime.now().plusHours(4), Organ.BONE, 3,1, false, 0);
        organsDatabase.insertOrgan(donatableOrgan);
    ...
    public void removeOrganTest() throws SQLException{
        DonatableOrgan donatableOrgan = new DonatableOrgan(LocalDateTime.now().plusHours(4), Organ.SKIN, 3, 1,false, 0);
        organsDatabase.insertOrgan(donatableOrgan);
