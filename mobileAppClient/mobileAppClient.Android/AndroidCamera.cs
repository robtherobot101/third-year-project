...
[assembly: Dependency(typeof(mobileAppClient.Droid.AndroidCamera))]
namespace mobileAppClient.Droid
{
    public class AndroidCamera : CameraInterface
    {
        ...
        public void LaunchCamera(FileFormatEnum fileType, string imageId)
        {
            ...
            if (takePictureIntent.ResolveActivity(MainActivity.ActivityContext.PackageManager) != null)
            {
                ...
                Android.Net.Uri photoURI = FileProvider.GetUriForFile(((Activity)MainActivity.ActivityContext), "team300.mobileAppClient.fileprovider", cameraFile);
